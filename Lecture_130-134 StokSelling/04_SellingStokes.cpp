...
public:
    int maxProfit(int k,vector<int>& prices){
        ...
        // return solvetab(prices,limit);
        return solvetabSO(prices,limit);
    }
};

    //  important   //

 // this qusn can be done using 2d dp 
        // using no of operation
        // if operation no is even then olny buy 
        // else sell only 
        // base case operation==2*k return 0;